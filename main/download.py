...
def tarifas(driver):
    ...
    rename_file('2937 PCAT CPFL Piratininga " + year + " V02.xlsx', 'CPFL- PIRATININGA." + year + "-10-23.xlsx') #'CPFL- PIRATININGA." + year + "-10-23.xlsx'
    #2937 PCAT CPFL Piratininga " + year + " V02

    # https://www2.aneel.gov.br/aplicacoes/tarifa/arquivo/4950%20PCAT%20Cemig-D%202020%20V02%20-%20P%C3%B3s%20Recurso.xlsx
    # https://www2.aneel.gov.br/aplicacoes/tarifa/arquivo/4950%20PCAT%20Cemig-D%202020%20V02.xlsx
